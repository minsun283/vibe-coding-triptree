  ...
  return (
    <div className="board-page__resources">
      ...
      <section className="resource-manage-panel">
        ...
        {isLoading && <p className="resource-manage-message">자료 목록을 불러오는 중...</p>}
                ...
                {resources.map((resource) => (
                  <tr key={resource._id}>
                    ...
                    <td className="resource-table__title">
                      <Link to={`/board/resources/${resource._id}`}>{resource.title}</Link>
                    </td>
                    ...
                    <td className="resource-table__status">
                      <label className="resource-table__status-label">
                        ...
                        <select
                          ...
                          onChange={(event) => handleStatusChange(resource, event.target.value)}
                        >
                          {RESOURCE_STATUSES.map((status) => (
                            <option key={status} value={status}>
                              {status}
