...
function ResourceDetailPage() {
  ...
  return (
    <div className="resource-detail-page">
      <main className="resource-detail-page__content">
        <div className="resource-detail-topbar">
          <Link to="/admin/resources" className="resource-detail-topbar__back">
          ...
          {resource && (
            <Link
              ...
              className="resource-detail-topbar__edit"
            >
          ...
          <article className="resource-detail">
            <header className="resource-detail__header">
              <div className="resource-detail__title-wrap">
                ...
                <span
                  className={`resource-status ${getStatusClassName(resource.status)}`}
                >
                  {resource.status}
                </span>
              </div>
            ...
            <section className="resource-detail__section">
              <h2 className="resource-detail__section-title">내용</h2>
            ...
            <section className="resource-detail__section">
              ...
              <form className="resource-detail__comment-form" onSubmit={handleCommentSubmit}>
                <label htmlFor="resource-comment" className="resource-detail__comment-label">
                  댓글 작성
                </label>
                <textarea
                  id="resource-comment"
